        ...
        switch (polygonType)
        {
            ...
            case Type.Intersects:
                { 
                    ...
                    if (f.Count >= 3)
                    {
                        front.Add(new Polygon(f)); //Добавляем новый полигон из точек спереди полигона
                    }
            ...
            case Type.Intersects:
                {
                    ...
                    if (f.Count >= 3)
                    {
                        ReturnList.AddRange(new Polygon(f).BreakApart()); //Добавляем новый полигон из точек спереди полигона
                    }
